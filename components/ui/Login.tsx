...
export const Login = ({ loginData, setLoginData, handleLogin }: LoginProps) => {
  ...
  <form onSubmit={handleSubmit} className="space-y-4">
    <div className="space-y-2">
      ...
      <span className="text-red-500">{simpleValidator.current.message("email", loginData.email, "required|email")}</span>
    </div>
    <div className="space-y-2">
      ...
      <span className="text-red-500">{simpleValidator.current.message("password", loginData.password, "required|min:6")}</span>
    </div>
