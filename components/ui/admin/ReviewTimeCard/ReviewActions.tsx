...
export default function ReviewActions({ reviewNotes, setReviewNotes, selectedTimecard, handleApprove, handleReject, handleFlag }: { reviewNotes: string, setReviewNotes: (value: string) => void, selectedTimecard: any, handleApprove: (timecardId: string) => void, handleReject: (timecardId: string) => void, handleFlag: (timecardId: string) => void }) {
  return (
