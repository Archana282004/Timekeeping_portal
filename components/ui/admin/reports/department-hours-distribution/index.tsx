...
const DepartmentHoursDistribution = ({ departmentHoursData }: { departmentHoursData: any }) =>{
              ...
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  ...
                  >
                    ...
                    {departmentHoursData.map((entry:any, index:any) => (
...
export default DepartmentHoursDistribution;