...
const DailyEntries = ({ selectedTimecard, reviewNotes, setReviewNotes, handleApprove, handleReject, handleFlag }: DailyEntriesProps) => {
  return (
    <div>
      {selectedTimecard && (
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              {selectedTimecard.dailyEntries.map((entry:any, index:any) => (
